...
ZO_CreateStringId("BARSTEWARD_COPY", "Select the text below, then use ctrl-c to copy it. The text can then be pasted into Bar Steward's 'Import Bar' box for another user.")
